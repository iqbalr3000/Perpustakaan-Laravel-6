...
<html>
<head>
<title>Registration - Uhuyy.com</title>
              ...
              <h3 class="login-heading mb-4">Daftar Akun baru</h3>
               <form action="{{url('post-registration')}}" method="POST" id="regForm">
                ...
                <div class="form-label-group">
                    ...
                    <input type="text" id="inputName" name="name" class="form-control" placeholder="Nama" autofocus>
                ...
                <div class="text-center">Sudah Punya akun?
                  <a class="small" href="{{url('login')}}">Masuk</a></div>
              </form>
            </div>
          </div>
        </div>
